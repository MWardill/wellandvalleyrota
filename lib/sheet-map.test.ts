...
describe("sheet-map", () => {
  ...
  it("tolerates missing trailing cells — active defaults to false", () => {
    const row = ["id1", "Soc", "", "2026-01-01", "2026-01-02", ""]; // active missing
    expect(rowToExhibition(row)).toEqual({
      id: "id1", societyName: "Soc", title: "", startDate: "2026-01-01",
      endDate: "2026-01-02", createdAt: "", active: false,
    });
  });
